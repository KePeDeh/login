    ...
    <table>
        ...
        <?php
            ...
            while ($res = mysqli_fetch_array($result)){
                ...
                echo "<td><a href=\"update.php?companyID=$res[companyID]\"onclick\return confirm('Adakah anda pasti?')\">KEMASKINI</a></td>";
                echo "<td><a href=\"delete.php?companyID=$res[companyID]\"onclick\return confirm('Adakah anda pasti?')\">HAPUS</a></td>";
